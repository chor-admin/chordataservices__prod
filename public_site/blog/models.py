...
class BlogStartPost(models.Model):
    ...
    image = models.ImageField(upload_to='start_a_business/', blank=True, null=True)
...
class BlogRunPost(models.Model):
    ...
    author = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete= models.CASCADE)
    content = models.TextField()
    image = models.ImageField(upload_to='run_a_business/', blank=True, null=True)
...
class BlogExitPost(models.Model):
    ...
    author = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete= models.CASCADE)
    content = models.TextField()
    image = models.ImageField(upload_to='exit_a_business/', blank=True, null=True)
